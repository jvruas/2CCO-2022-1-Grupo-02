...
public class GerenciadorUsuario {
    ...
    public static boolean logoff(Integer idUsuario) {
        return listaLogados.removeElemento(new UsuarioLogadoResponse(idUsuario, null, null, null, null, null, null, null, null, null, null, null));
    }
	...
	public static Optional<UsuarioLogadoResponse> buscaUsuarioLogado(Integer idUsuario){
		int indice = listaLogados.busca(new UsuarioLogadoResponse(idUsuario, null, null, null, null, null, null, null, null, null, null, null));
