...
public interface UsuarioRepository extends JpaRepository<Usuario, Integer> {
	...
	@Query("select new com.conture.apiusuario.dto.response.UsuarioLogadoResponse(u.idUsuario, u.email, u.nome, u.sobrenome, u.genero, u.dataNascimento, u.estadoCivil, u.telefone, u.cep, u.uf, u.dataCadastro, u.grauEscolaridade, u.cpf, u.situacaoAtual.nome) from Usuario u where u.email = ?1 and u.senha = ?2")
	Optional<UsuarioLogadoResponse> getByEmailAndSenha(String email, String senha);

	@Query("select new com.conture.apiusuario.dto.response.UsuarioLogadoResponse(u.idUsuario, u.email, u.nome, u.sobrenome, u.genero, u.dataNascimento, u.estadoCivil, u.telefone, u.cep, u.uf, u.dataCadastro, u.grauEscolaridade, u.cpf, u.situacaoAtual.nome) from Usuario u where u.idUsuario = ?1 and u.removido = false")
	Optional<UsuarioLogadoResponse> getUsuarioLogadoById(Integer idUsuario);

	@Query("select new com.conture.apiusuario.dto.response.UsuarioLogadoResponse(u.idUsuario, u.email, u.nome, u.sobrenome, u.genero, u.dataNascimento, u.estadoCivil, u.telefone, u.cep, u.uf, u.dataCadastro, u.grauEscolaridade, u.cpf, u.situacaoAtual.nome) from Usuario u where concat(u.nome,' ',u.sobrenome) like concat('%',?1,'%') order by u.nome")
